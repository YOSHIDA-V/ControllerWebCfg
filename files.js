    ...
    .then(_ => {
        ...
        try {
            if (showLatestFirmwareNotice && app_ver.indexOf(latest_ver) == -1) {
                document.getElementById("divInfo").innerHTML += '<br><br>最新FW ' + latest_ver + ' を <a href=\'https://github.com/YOSHIDA-V/blueretro-vs-c4-firmware/releases\'>GitHub</a>からダウンロードしてください';
            }
        }
        catch (e) {
            // Just move on
